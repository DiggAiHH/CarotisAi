...
- [kimi_prompt_p0f_pivot_ready.md](kimi_prompt_p0f_pivot_ready.md) — **P0f-PROMPTS**: 12 Wellen (W-01..W-12) fuer Kimi K2.6 + Codex GPT-5.5 + Sonnet 4.6 — Public Webseite, Demo-Deploy, Walkthrough, Rohde-Kit, Stride V3, Mail v3.
